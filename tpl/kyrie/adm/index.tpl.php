...
<html lang="en">
	<head>
		...
		<script>var tpldir = "<?php echo $this->tpldir?>";</script>
	...
	<body style="background-image: url(<?php echo $this->tpldir?>img/bg.png);">
		<div id="container">
			...
			<nav id="sidebar">
				<h1>Links</h1>
				<h2><a href="#addlink">Add a Link <img src="<?php echo $this->tpldir?>/adm/img/add.png" alt="Add a Link" width="16" height="16" title="Add a Link" class="inlineicon" /></a></h2>
				<h2><a href="#editlinks">Edit Links <img src="<?php echo $this->tpldir?>/adm/img/edit.png" alt="Edit Links" width="16" height="16" title="Edit Links" class="inlineicon" /></a></h2>
